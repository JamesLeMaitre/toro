...
public class JwtUtils {
    ...
    public String generateJwtToken(UserPrincipal usersDetails) {
        String[] claims = getClaimsFromUser(usersDetails);
        return JWT.create()
                .withIssuer(GET_ARRAYS_LLC)
                .withAudience(GET_ARRAYS_ADMINISTRATION)
                .withIssuedAt(new Date())
                .withSubject(usersDetails.getUsername())
    ...
    private JWTVerifier getJWTVerifier() {
        ...
        try {
            ...
            throw new JWTVerificationException(JavaConstant.TOKEN_CANNOT_BE_VERIFIED);
        }
        return verifier;
    }
